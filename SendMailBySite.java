package com.test.automation.ibvAutomation.mail;
...
public class SendMailBySite {	
	...
	public static void main(String[]args) throws IOException {
		...
		//	SimpleDateFormat formater = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss");
	        final String username = "roshan_ma@rnr.com";
	        final String password = "xxx";
	              ...
	              String[] to={"roshan_mankani@rnr.com"};
	              String[] cc={"dilip_shrivastava@rnr.com"};
	              String[] bcc={};
	        ...
	        try {
	            ...
	            message.setFrom(new InternetAddress("roshan_mankani@rnr.com"));
